...
Eksempel: Versjon 2.1.3 betyr andre hovedversjon, første mindre oppdatering, og tredje feilretting.`,
  ...
  section: {
    ...
    remarkTitle: "Merknad",
    remarkSubtitle:
      "Tilleggsopplysninger som tydeliggjør betydningen og bruken av begrepet.",
    relationTitle: "Relasjoner",
    relationSubtitle: "Relasjoner til andre begrep.",
    subjectTitle: "Fagområde",
    subjectSubtitle:
      "Spesialisert kunnskapsområde som begrepet grupperes under.",
    ...
    periodSubtitle:
      "Datoene begrepet skal gjelde fra og med og/eller til og med.",
  ...
  validation: {
    ...
    subjectConflict:
      "Det er ikke tillatt å ha både fagområde som fritekst og kodeliste.",
  },
};
