export const datasetFormNb = {
  helptext: {
    ...
    accessServices: 'Datatjenester som gir tilgang til distribusjon av datasettet.',
    license:
    ...
    relatedResources: 'Beslektet ressurs, uten nærmere angivelse av type relasjon.',
  ...
  subtitle: {
    ...
    theme: 'Tema knyttet til datasettet, et datasett kan være assosiert med flere tema.',
    distributions: 'Tilgjengelige distribusjoner for datasettet og eksempeldata som illustrerer datasettet.',
    ...
    contactPoint: 'Kontaktpunkt som kan brukes vedr. spørsmål og kommentarer om datasettet.',
  },
  fieldLabel: {
    ...
    currentness: 'Aktualitet: Avvik eller tilleggsopplysninger om oppdateringsfrekvens',
