...
export const nb = {
  ...
  catalogAccessDocumentationLink: 'Se dokumentasjon for hvordan du kan få tilgang.',
...
* _Turtle format tillater opplastning av inntil 300 begreper per fil_
      `,
      alert: {
  ...
  changeRequest: {
    ...
    needWriteAccessForOther: 'Skrivetilgang kreves for å redigere, godta eller avvise andres endringsforslag.',
