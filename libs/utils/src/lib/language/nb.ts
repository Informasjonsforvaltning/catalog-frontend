...
export const nb = {
  ...
  youHaveNoAccessToCatalogs:
    "Det ser ikke ut til at du har tilgang til noen kataloger.",
  catalogAccessDocumentationLink:
    "Se dokumentasjon for hvordan du kan få tilgang.",
  ...
  alert: {
    ...
    maxFileSizeExceeded:
      "Filstørrelsen er mer enn maksimumsgrensen på {0} MB. Importering avbrytes.",
...
[kontakt oss](https://data.norge.no/nb/contact) hvis problemet vedvarer.`,
  ...
  catalogAdmin: {
    ...
    description: {
      conceptCatalog:
        "Her kan du administrere innstillinger og innhold for begrepskatalogen.",
      general:
        "Her kan du administrere innstillinger og innhold på tvers av katalogene.",
    },

    manage: {
      codeList:
        "Her kan du administrere kodelistene som brukes av interne og editerbare felt.",
      conceptCatalog: "Administrere begrepskatalog",
      design: "Administrer organisasjonsspesifikt design",
      editableFields:
        "Her kan du velge kodelister for felt som publiseres eksternt, som fagområde.",
      enableFilter:
        "Gjør det mulig å filtrere på feltet i søk i intern begrepskatalog.",
      internalFields:
        "Her kan du legge til, endre og fjerne interne felt som er spesifikke for din virksomhet.",
    ...
    designHelpText: {
      ...
      logoDescription:
        'Beskrivelse av virksomhetens logo. Eksempel: "Logo digdir"',
    },
  ...
  concept: {
    ...
    unpublishedRelatedConcepts:
      "Relaterte begreper - upubliserte ({conceptCount})",
...
`,
  ...
  changeRequest: {
    ...
    needWriteAccess: "Skrivetilgang kreves for å godta eller avvise.",
    needWriteAccessForOther:
      "Skrivetilgang kreves for å redigere, godta eller avvise andres endringsforslag.",
  ...
  serviceCatalog: {
    ...
    form: {
      ...
      titleSubtitle:
        "Navnet skal være kortfattet, kunne stå alene og gi mening.",
    },
  },
  datasetCatalog: {
  ...
  termsOfUse: {
    ...
    acceptCheckbox:
      "Som bemyndiget person aksepterer jeg bruksvilkår for Felles datakatalog på vegne av virksomheten.",
