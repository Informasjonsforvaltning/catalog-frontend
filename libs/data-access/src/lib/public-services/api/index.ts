...
export const getAllPublicServices = async (catalogId: string, accessToken: string) => {
  ...
  const encodedCatalogId = validateAndEncodeUrlSafe(catalogId, 'catalog ID', 'getAllPublicServices');
...
export const getPublicServiceById = async (catalogId: string, serviceId: string, accessToken: string) => {
  ...
  const encodedCatalogId = validateAndEncodeUrlSafe(catalogId, 'catalog ID', 'getPublicServiceById');
  const encodedServiceId = validateAndEncodeUrlSafe(serviceId, 'service ID', 'getPublicServiceById');
...
export const createPublicService = async (publicService: Partial<Service>, catalogId: string, accessToken: string) => {
  ...
  const encodedCatalogId = validateAndEncodeUrlSafe(catalogId, 'catalog ID', 'createPublicService');
...
export const deletePublicService = async (catalogId: string, serviceId: string, accessToken: string) => {
  ...
  const encodedCatalogId = validateAndEncodeUrlSafe(catalogId, 'catalog ID', 'deletePublicService');
  const encodedServiceId = validateAndEncodeUrlSafe(serviceId, 'service ID', 'deletePublicService');
...
export const updatePublicService = async (
  ...
  const encodedCatalogId = validateAndEncodeUrlSafe(catalogId, 'catalog ID', 'updatePublicService');
  const encodedServiceId = validateAndEncodeUrlSafe(serviceId, 'service ID', 'updatePublicService');
...
export const publishPublicService = async (catalogId: string, serviceId: string, accessToken: string) => {
  ...
  const encodedCatalogId = validateAndEncodeUrlSafe(catalogId, 'catalog ID', 'publishPublicService');
  const encodedServiceId = validateAndEncodeUrlSafe(serviceId, 'service ID', 'publishPublicService');
...
export const unpublishPublicService = async (catalogId: string, serviceId: string, accessToken: string) => {
  ...
  const encodedCatalogId = validateAndEncodeUrlSafe(catalogId, 'catalog ID', 'unpublishPublicService');
  const encodedServiceId = validateAndEncodeUrlSafe(serviceId, 'service ID', 'unpublishPublicService');
