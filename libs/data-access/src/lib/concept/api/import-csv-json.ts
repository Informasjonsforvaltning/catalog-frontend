...
export const importConceptsCSV = async (
  ...
  const encodedCatalogId = validateAndEncodeUrlSafe(catalogId, 'catalog ID', 'importConceptsCSV');
  const encodedResultId = validateAndEncodeUrlSafe(importId, 'result ID', 'importConceptsCSV');
