...
export type FancyArticleInput = {
  Content?: InputMaybe<Array<Scalars['FancyArticleContentDynamicZoneInput']['input']>>;
  publishedAt?: InputMaybe<Scalars['DateTime']['input']>;
...
export function useGetServiceMessagesSuspenseQuery(
  baseOptions?:
    | Apollo.SkipToken
    | Apollo.SuspenseQueryHookOptions<GetServiceMessagesQuery, GetServiceMessagesQueryVariables>,
) {
...
export function useGetServiceMessageSuspenseQuery(
  baseOptions?:
    | Apollo.SkipToken
    | Apollo.SuspenseQueryHookOptions<GetServiceMessageQuery, GetServiceMessageQueryVariables>,
) {
  const options = baseOptions === Apollo.skipToken ? baseOptions : { ...defaultOptions, ...baseOptions };
