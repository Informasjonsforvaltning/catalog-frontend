...
export const SearchPageClient = ({
  ...
  // Query states
  const [selectedFieldOption, setSelectedFieldOption] = useQueryState('field', {
    defaultValue: defaultSelectedFieldOption,
  });
  const [selectedSortOption, setSelectedSortOption] = useQueryState('sort', {
    defaultValue: defaultSelectedSortOption,
  });
  const [page, setPage] = useQueryState('page', parseAsInteger.withDefault(defaultPage));
  const [searchTerm, setSearchTerm] = useQueryState('search', { defaultValue: defaultSearchTerm });
