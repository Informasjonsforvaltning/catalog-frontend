...
runTestAsAdmin(
  "should allow editing dataset about section",
  async ({ page, datasetsPage, playwright }) => {
    ...
    await detailPage.goto(process.env.E2E_CATALOG_ID as any, dataset.id);
    ...
    await editPage.expectDescriptionField(
      "Bokmål",
      dataset.description.nb as string,
    );
...
runTestAsAdmin(
  "should edit dataset theme section",
...
runTestAsAdmin(
  "should edit dataset distribution section",
  async ({ datasetsPage, playwright }) => {
    const dataset = await createRandomDataset(playwright);
    const detailPage: DatasetDetailPage = datasetsPage.detailPage;
    const editPage: DatasetEditPage = datasetsPage.editPage;
    ...
    await detailPage.expectDistributionAccessUrl(
...
runTestAsAdmin(
  "should edit dataset details section",
  async ({ datasetsPage, playwright }) => {
    const dataset = await createRandomDataset(playwright);
    const detailPage: DatasetDetailPage = datasetsPage.detailPage;
    const editPage: DatasetEditPage = datasetsPage.editPage;
...
runTestAsAdmin(
  "should edit dataset concept section",
  async ({ datasetsPage, playwright }) => {
    const dataset = await createRandomDataset(playwright);
    const detailPage: DatasetDetailPage = datasetsPage.detailPage;
    const editPage: DatasetEditPage = datasetsPage.editPage;
...
runTestAsAdmin(
  "should edit dataset information model section",
  async ({ datasetsPage, playwright }) => {
    const dataset = await createRandomDataset(playwright);
    const detailPage: DatasetDetailPage = datasetsPage.detailPage;
    const editPage: DatasetEditPage = datasetsPage.editPage;
...
runTestAsAdmin(
  "should edit dataset contact point section",
  async ({ datasetsPage, playwright }) => {
    const dataset = await createRandomDataset(playwright);
    const detailPage: DatasetDetailPage = datasetsPage.detailPage;
    const editPage: DatasetEditPage = datasetsPage.editPage;
