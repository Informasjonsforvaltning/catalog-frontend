...
export default class LoginPage {
  ...
  // Helpers
  public async goto() {
    const url = `/auth/signin?callbackUrl=/catalogs/${process.env.E2E_CATALOG_ID}/datasets`;
  ...
  public async loginAsAdmin() {
    ...
    try {
      ...
      console.log(
        '[LOGIN PAGE] "Sign in with Keycloak" button not found or not visible, proceeding...',
      );
    }
    ...
    await expect(this.page.getByText("ØKONOMISK FREIDIG TIGER AS")).toBeVisible(
      { timeout: 5000 },
    );
