...
export const reducer = produce(
  (state: AdminState, action: ACTION): AdminState => {
    switch (action.type) {
      case "POPULATE": {
      ...
      case "SET_SHOW_INTERNAL_FIELD_EDITOR": {
        return {
          ...state,
          showInternalFieldEditor: action.payload.showInternalFieldEditor,
        };
      }
      case "SET_SHOW_CODE_LIST_EDITOR": {
        return {
          ...state,
          showCodeListEditor: action.payload.showCodeListEditor,
        };
      }
